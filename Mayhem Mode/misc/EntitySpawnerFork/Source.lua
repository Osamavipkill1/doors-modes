...
-- FIX: both requires used to crash unconditionally if either path changed in a Doors
-- update. This was the root cause of NM Rush and Ambush never spawning.
...
Spawner.createEntity = function(config)
    ...
    if typeof(entityModel) == "Instance" and entityModel.ClassName == "Model" then
        ...
        if entityModel.PrimaryPart then
            ...
            -- FIX: clearer failure reason for debugging instead of silently returning nil
