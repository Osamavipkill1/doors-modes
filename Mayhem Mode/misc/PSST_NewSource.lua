local AttackPlaySound = game:GetService("StarterGui").MainUI.Initiator.Main_Game.RemoteListener.Modules.Screech.Attack
local CaughtPlaySound = game:GetService("StarterGui").MainUI.Initiator.Main_Game.RemoteListener.Modules.Screech.Caught
local SelfModules = {
