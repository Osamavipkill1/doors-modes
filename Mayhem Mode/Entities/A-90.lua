...
function RunA90Jumpscare(p1)
	...
	if u3 then
		...
		local hintOk, hintErr = pcall(function()
			FireDeathHint({"Oh... hello.", "Not this place again...", "Nevermind that... What'd you die to?", "Oh... the flash.", "It wants you to freeze completely, so...", "Maybe you could call it H-10?", "Anyways, I hope you don't mind trying again. It would be helpful."}, "Yellow")
		end)
		if not hintOk then
