...
-- FIX: damage now fires the INSTANT you look away (was a 1s wind-up), then repeats
-- every 0.5s for as long as you keep not looking, resetting the moment you look back.
