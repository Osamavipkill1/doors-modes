...
function setup_blackout()
    ...
    RS.Stepped:Connect(function()
        ...
        then
            ...
            -- FIX: 1.8s of just the static image (was 0.5+0.3=0.8s before the zoom even started)
            task.wait(1.8)

            -- FIX: fast 0.2s zoom (two 0.1s tweens back-to-back) -- a quick zoom reads as
            -- more of a jumpscare than the old slow 0.3s crawl
            ...
            task.wait(0.1)
            -- total on-screen before death: 1.8 + 0.1 + 0.1 = 2.0s exactly

            humanoid.Health = 0
            -- FIX: dying to Blackout now shows up properly instead of "Unknown"
