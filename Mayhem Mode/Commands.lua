...
local function noseekeyes()
    loadstring(CachedHttpGet("https://raw.githubusercontent.com/Osamavipkill1/doors-modes/refs/heads/main/Mayhem%20Mode/Seek%20Eyes.lua"))()
end
